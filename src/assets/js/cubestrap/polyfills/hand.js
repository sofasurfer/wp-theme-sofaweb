...
//                          |__/
//
// Forked by Goldbach Interactive (Switzerland) AG
// Maintainer: (andreas.roth@goldbachinteractive.ch)
//
var HANDJS = HANDJS || {};
...
(function () {
	...
	var checkSuppress = function (node) {
        while (node && !node.handjs_suppress) {
            node = node.parentNode;
        }
        return !!node || window.handjs_suppress;
    };
    ...
    var interceptAddEventListener = function (root) {
        ...
        var customAddEventListener = function (name, func, capture) {
            ...
            if ((supportedEventsNames.indexOf(name) !== -1) && !checkSuppress(this)) {
